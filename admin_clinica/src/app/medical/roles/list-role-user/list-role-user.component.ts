...
export class ListRoleUserComponent {
  ...
  deleteRol() {
    ...
    this.role_w_users = null;
    this.RolesService.deleteRoles(this.role_selected.id).subscribe((res: any) => {
  ...
  public searchData(value: any): void {
    ...
    if (!value) {
      ...
      this.dataSource.filter = value.trim().toLowerCase();
      this.rolesList = this.dataSource.filteredData;
      this.calculateTotalPages((this.rolesList.length > this.pageSize ? this.pageSize : this.rolesList.length), this.pageSize);
    }
